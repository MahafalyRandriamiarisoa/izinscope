...
def main():
    parser = argparse.ArgumentParser(description="Inzinscope : Check IP/domain vs scope")
    ...
    parser.add_argument('--version', action='version', version='Inzinscope 1.1')
    ...
    if args.debug:
        ...
        logfile = open(f"log_inzinscope_{timestamp}.log", 'w', encoding='utf-8')
